...
//        processRequest(request, response);
        ...
        System.out.println("Im in registerPOST doPOST section");
        
        JSONConverter jc = new JSONConverter();
        String data = jc.getJSONFromAjax(request.getReader());
        System.out.println("This is what i got from the ajax " + data);
//        User user = jc.jsonToUser(request.getReader());
//        System.out.println("I got the user and his username is " + user.getUsername());
