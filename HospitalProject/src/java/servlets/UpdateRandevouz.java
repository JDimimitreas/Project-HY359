...
public class UpdateRandevouz extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            System.out.println("Im in UpdateRandevouz");
            String doctor_info = request.getParameter("doctor_info");
            String status      = request.getParameter("status");
            int randevouzID    = Integer.parseInt(request.getParameter("randevouz_id"));
            int user_id        = Integer.parseInt(request.getParameter("user_id"));
            
            System.out.println("doctor_info: " + doctor_info + ", randevouzID: " + randevouzID + ", user_id: " + user_id + ", status: " + status);
            
            EditRandevouzTable ert = new EditRandevouzTable();
            ert.updateRandevouz(randevouzID, user_id, doctor_info, status);
